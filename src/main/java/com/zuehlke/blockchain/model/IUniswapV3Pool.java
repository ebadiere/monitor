...
public class IUniswapV3Pool extends Contract {
    ...
    public static final Event BURN_EVENT = new Event("Burn", 
            Arrays.asList(new TypeReference<Address>(true) {}, new TypeReference<Int24>(true) {}, new TypeReference<Int24>(true) {}, new TypeReference<Uint128>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}));


    public static final Event COLLECT_EVENT = new Event("Collect", 
            Arrays.asList(new TypeReference<Address>(true) {}, new TypeReference<Address>() {}, new TypeReference<Int24>(true) {}, new TypeReference<Int24>(true) {}, new TypeReference<Uint128>() {}, new TypeReference<Uint128>() {}));


    public static final Event COLLECTPROTOCOL_EVENT = new Event("CollectProtocol", 
            Arrays.asList(new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}, new TypeReference<Uint128>() {}, new TypeReference<Uint128>() {}));


    public static final Event FLASH_EVENT = new Event("Flash", 
            Arrays.asList(new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}));


    public static final Event INCREASEOBSERVATIONCARDINALITYNEXT_EVENT = new Event("IncreaseObservationCardinalityNext", 
            Arrays.asList(new TypeReference<Uint16>() {}, new TypeReference<Uint16>() {}));


    public static final Event INITIALIZE_EVENT = new Event("Initialize", 
            Arrays.asList(new TypeReference<Uint160>() {}, new TypeReference<Int24>() {}));


    public static final Event MINT_EVENT = new Event("Mint", 
            Arrays.asList(new TypeReference<Address>() {}, new TypeReference<Address>(true) {}, new TypeReference<Int24>(true) {}, new TypeReference<Int24>(true) {}, new TypeReference<Uint128>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}));


    public static final Event SETFEEPROTOCOL_EVENT = new Event("SetFeeProtocol", 
            Arrays.asList(new TypeReference<Uint8>() {}, new TypeReference<Uint8>() {}, new TypeReference<Uint8>() {}, new TypeReference<Uint8>() {}));


    public static final Event SWAP_EVENT = new Event("Swap", 
            Arrays.asList(new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}, new TypeReference<Int256>() {}, new TypeReference<Int256>() {}, new TypeReference<Uint160>() {}, new TypeReference<Uint128>() {}, new TypeReference<Int24>() {}));


    @Deprecated
    protected IUniswapV3Pool(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected IUniswapV3Pool(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected IUniswapV3Pool(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected IUniswapV3Pool(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public static List<BurnEventResponse> getBurnEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<BurnEventResponse> responses = new ArrayList<>(valueList.size());
    ...
    public static List<CollectEventResponse> getCollectEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<CollectEventResponse> responses = new ArrayList<>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public static List<CollectProtocolEventResponse> getCollectProtocolEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<CollectProtocolEventResponse> responses = new ArrayList<>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public static List<FlashEventResponse> getFlashEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<FlashEventResponse> responses = new ArrayList<>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public static List<IncreaseObservationCardinalityNextEventResponse> getIncreaseObservationCardinalityNextEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<IncreaseObservationCardinalityNextEventResponse> responses = new ArrayList<>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public static List<InitializeEventResponse> getInitializeEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<InitializeEventResponse> responses = new ArrayList<>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public static List<MintEventResponse> getMintEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<MintEventResponse> responses = new ArrayList<>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public static List<SetFeeProtocolEventResponse> getSetFeeProtocolEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<SetFeeProtocolEventResponse> responses = new ArrayList<>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public static List<SwapEventResponse> getSwapEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<SwapEventResponse> responses = new ArrayList<>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public RemoteFunctionCall<BigInteger> fee() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_FEE,
            List.of(),
            List.of(new TypeReference<Uint24>() {
            }));
    ...
    public RemoteFunctionCall<TransactionReceipt> increaseObservationCardinalityNext(BigInteger observationCardinalityNext) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
            ...
            List.of(new Uint16(observationCardinalityNext)),
                Collections.emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> initialize(BigInteger sqrtPriceX96) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_INITIALIZE,
            List.of(new Uint160(sqrtPriceX96)),
                Collections.emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<Tuple4<BigInteger, BigInteger, BigInteger, Boolean>> observations(BigInteger index) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_OBSERVATIONS,
            List.of(new Uint256(index)),
                Arrays.asList(new TypeReference<Uint32>() {}, new TypeReference<Int56>() {}, new TypeReference<Uint160>() {}, new TypeReference<Bool>() {}));
    ...
    public RemoteFunctionCall<Tuple2<List<BigInteger>, List<BigInteger>>> observe(List<BigInteger> secondsAgos) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_OBSERVE,
            List.of(new DynamicArray<>(
                Uint32.class,
                Utils.typeMap(secondsAgos, Uint32.class))),
                Arrays.asList(new TypeReference<DynamicArray<Int56>>() {}, new TypeReference<DynamicArray<Uint160>>() {}));
        return new RemoteFunctionCall<>(function,
            () -> {
                List<Type> results = executeCallMultipleValueReturn(function);
                return new Tuple2<>(
    ...
    public RemoteFunctionCall<Tuple5<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger>> positions(byte[] key) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_POSITIONS,
            List.of(new Bytes32(key)),
                Arrays.asList(new TypeReference<Uint128>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint128>() {}, new TypeReference<Uint128>() {}));
        return new RemoteFunctionCall<>(function,
            () -> {
                List<Type> results = executeCallMultipleValueReturn(function);
                return new Tuple5<>(
    ...
    public RemoteFunctionCall<Tuple2<BigInteger, BigInteger>> protocolFees() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_PROTOCOLFEES,
            List.of(),
                Arrays.asList(new TypeReference<Uint128>() {}, new TypeReference<Uint128>() {}));
        return new RemoteFunctionCall<>(function,
            () -> {
                List<Type> results = executeCallMultipleValueReturn(function);
                return new Tuple2<>(
    ...
    public RemoteFunctionCall<TransactionReceipt> setFeeProtocol(BigInteger feeProtocol0, BigInteger feeProtocol1) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETFEEPROTOCOL, 
                Arrays.asList(new org.web3j.abi.datatypes.generated.Uint8(feeProtocol0),
    ...
    public RemoteFunctionCall<Tuple7<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, Boolean>> slot0() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_SLOT0,
            List.of(),
                Arrays.asList(new TypeReference<Uint160>() {}, new TypeReference<Int24>() {}, new TypeReference<Uint16>() {}, new TypeReference<Uint16>() {}, new TypeReference<Uint16>() {}, new TypeReference<Uint8>() {}, new TypeReference<Bool>() {}));
        return new RemoteFunctionCall<>(function,
            () -> {
                List<Type> results = executeCallMultipleValueReturn(function);
                return new Tuple7<>(
    ...
    public RemoteFunctionCall<Tuple3<BigInteger, BigInteger, BigInteger>> snapshotCumulativesInside(BigInteger tickLower, BigInteger tickUpper) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_SNAPSHOTCUMULATIVESINSIDE, 
                Arrays.asList(new org.web3j.abi.datatypes.generated.Int24(tickLower),
                new org.web3j.abi.datatypes.generated.Int24(tickUpper)), 
                Arrays.asList(new TypeReference<Int56>() {}, new TypeReference<Uint160>() {}, new TypeReference<Uint32>() {}));
        return new RemoteFunctionCall<>(function,
            () -> {
                List<Type> results = executeCallMultipleValueReturn(function);
                return new Tuple3<>(
    ...
    public RemoteFunctionCall<BigInteger> tickBitmap(BigInteger wordPosition) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_TICKBITMAP,
            List.of(new Int16(wordPosition)),
            List.of(new TypeReference<Uint256>() {
            }));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<Tuple8<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, Boolean>> ticks(BigInteger tick) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_TICKS,
            List.of(new Int24(tick)),
                Arrays.asList(new TypeReference<Uint128>() {}, new TypeReference<Int128>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Int56>() {}, new TypeReference<Uint160>() {}, new TypeReference<Uint32>() {}, new TypeReference<Bool>() {}));
        return new RemoteFunctionCall<>(function,
            () -> {
                List<Type> results = executeCallMultipleValueReturn(function);
                return new Tuple8<>(
    ...
    @Deprecated
    public static IUniswapV3Pool load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new IUniswapV3Pool(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static IUniswapV3Pool load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new IUniswapV3Pool(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static IUniswapV3Pool load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new IUniswapV3Pool(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static IUniswapV3Pool load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new IUniswapV3Pool(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static RemoteCall<IUniswapV3Pool> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IUniswapV3Pool.class, web3j, credentials, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<IUniswapV3Pool> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IUniswapV3Pool.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<IUniswapV3Pool> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IUniswapV3Pool.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<IUniswapV3Pool> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IUniswapV3Pool.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
